          ...
          while ($fila = mysqli_fetch_array($rselectMaes)) {
            ...
            echo "
              <tr>
                ...
                <td><a type='button' class='btn' href='../src/php/delete_maes.php?id_maes=".$fila['id_est']."'>
              ...
              <div class='modal-dialog modal-lg'>
                <div class="modal-content">
                  <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Agregar maestria</h4>
                  </div>

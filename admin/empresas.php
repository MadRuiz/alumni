  ...
  <div class="x_panel">
    <div class="x_title">
      ...
      <ul class="nav navbar-right panel_toolbox">
        <li><a type="button" class="" data-toggle="modal" data-target=".nuevoEmpreForm"><i class="fa fa-plus"></i> Nuevo </a></li>
    ...
    <div class="x_content">
      ...
      <?php
        ...
        $selectEmpre = "SELECT *
                        FROM empresas 
                      ";
        $rselectEmpre = mysqli_query($conexion, $selectEmpre);
          while ($fila = mysqli_fetch_array($rselectEmpre)) {
            $contador ++;
            echo "
              <tr>
                ...
                <td><a type='button' class='btn' href='../src/php/delete_empr.php?id_empr=".$fila['id_empresa']."'>
...
<!-- formulario ingreso doctorados-->
      <div class='modal fade nuevoEmpreForm' tabindex='-1' role='dialog' aria-hidden='true'>
